...
class wc_mpu_hash_helper{
	...
	function wc_mpu_is_valid_hash($parameter){
		...
		$secret_key  = $this->pg_mpu_setting_values['key_secret'];
	...
	//This function is used to create hash value and sent to mpu PG.
    function wc_mpu_create_hashvalue($parameter){
    	...
    	$SECRETKEY  = esc_attr($this->pg_mpu_setting_values['key_secret']);   
