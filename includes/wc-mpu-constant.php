...
class WC_mpu_Constant{
    const WC_mpu_VERSION = '1.0.1'; //Current version used for mpu integration.
    const WC_mpu_DEFAULT_LANG = 'en_GB'; //Payment getaway default langauge supported.    
}

class WC_mpu_currency{
